...
import { getLogo, getPoolId, getPoolName } from '@/utils/saber/pool'
...
import LoadingText from '@/components/saber/ui/LoadingText'
import { Button } from '@/components/saber/ui/Button'
import { Input, InputType } from '@/components/saber/ui/Input'
import ActiveText from '@/components/saber/ui/ActiveText'
import PoolSwitch, { PoolsView } from '@/components/saber/pool/PoolSwitch'
import { CurrencyMarket, PoolData } from '@/types/saber'
import { toAPY, toPrecision } from '@/utils/saber/number'
import useGetPrices from '@/hooks/saber/useGetPrices'
import useGetStats from '@/hooks/saber/useGetStats'
import useDeprecatedPools from '@/hooks/saber/useDeprecatedPools'
import useFeaturedPools from '@/hooks/saber/useFeaturedPools'
...
export default function IndexPage() {
    ...
    const filterCurrency = watch('filterCurrency') || undefined;
                                ...
                                <>
                                    {poolsView !== PoolsView.GRID && (
                                        <div className="flex justify-end">
                                            <Button 
                                                className="hidden lg:inline-block bg-white !text-black border border-[#33425E] font-normal transition-all hover:bg-[#33425E] hover:!text-white hover:border-white" 
                                                key="button"
                                            >
                                                View
                                            </Button>
    ...
    }, [pools, wallet, deprecatedPools, featuredPools, poolsView, sort, price, filterText, filterCurrency, filterDeprecated, filterMyPools]);
        ...
        <div className="flex-1 flex flex-col">
            <div>
                <div className="mt-20 mb-6">
                    <div className="flex-1 flex justify-center gap-4 mb-12">
                ...
                <div className="block lg:flex items-center mb-3 mt-10">
