...
/**
 * Program names enum containing all supported programs
 */
...
/**
 * Mapping of program IDs to their names
 */
...
/**
 * Mapping of loader IDs to their names
 */
...
/**
 * Gets the program label for a given address
 */
export function programLabel(address: string): string | undefined {
    return PROGRAM_NAME_BY_ID[address] ?? LOADER_IDS[address]
}

/**
 * Gets the token label for a given address
 */
...
/**
 * Gets the address label for a given address
 */
...
/**
 * Displays an address, optionally shortened
 */
...
/**
 * Set of known non-Anchor programs
 */
