...
import type { SmartWalletEvents, SmartWalletTransactionData } from '@gokiprotocol/client'
...
interface DetailedTransaction extends LoadedTransaction {
    index: number
    id: string
    title: string
...
interface HistoricalTX extends TransactionResponse {
    sig: string
    date: Date | null | undefined
    events: readonly SmartWalletEvent[]
}

type SmartWalletEvent = SmartWalletEvents[keyof SmartWalletEvents]

/**
 * Hook for managing transaction details
 */
function useTransactionInner(tx?: LoadedTransaction): DetailedTransaction {
    if (!tx) {
...
const { useContainer: useTransaction, Provider: TransactionProvider } = createContainer(useTransactionInner)

export type { DetailedTransaction, HistoricalTX, LoadedTransaction, SmartWalletEvent }
